...
void displaySleepCallback() { displayNotifyCommon(3); }

void displayWakeCallback() { displayNotifyCommon(2); }

unsigned int SLSDisplayManagerRegisterPowerStateNotification(dispatch_queue_t rdi_queue, unsigned int esi, unsigned int edx_type,
                                                             dispatch_block_t rcx_block) {
