...
long SLSWindowGetBestSpace(int edi_wid, int esi) { return 1; }
...
void SLSSpaceClientDrivenMoveSpacersToPointFenced(int edi_cid, long rsi_spaceID, long rdx_verticalIndex, long rcx_horizontalIndex,
                                                  long r8_flags, int r9d_fencePort, double xmm0_location, double xmm1) {
