...
Wrapper* defenestratorGetWrapper(int wid) { return wrappers[[NSNumber numberWithInt:wid]]; }
...
void SLSTransactionCommitUsingMethod(void* rdi, int esi) { SLSTransactionCommit(rdi, esi); }
