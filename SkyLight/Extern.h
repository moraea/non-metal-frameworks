...
int SLSNewWindowWithOpaqueShap$(int edi_connectionID, int esi, char* rdx_region, char* rcx_region, int r8d, char* r9,
                                unsigned long stack1_windowID, unsigned long stack2, double xmm0, double xmm1);
...
CFMachPortRef SLSEventTapCreat$(int edi_location, NSString* rsi_priority, int edx_placement, int ecx_options,
                                unsigned long r8_eventsOfInterest, void* r9_callback, void* stack_info);
...
void SLSSystemStatusBarRegisterSortedWindow(int edi_connectionID, int esi_windowID, int edx_priority, unsigned long rcx_spaceID,
                                            unsigned long r8_displayID, int r9d_flags, float xmm0_preferredPosition);
void SLSSystemStatusBarRegisterReplicantWindow(int edi_connectionID, int edi_windowID, int edx_windowNumber, unsigned long rcx_displayID,
                                               int r8d_flags);
...
char* SLSWindowBackdropCreateWithLevelAndTintColor(int edi_windowID, NSString* rsi_material, NSString* rdx_blendMode,
                                                   unsigned long rcx_level, CGColorRef r8_tintColor, CGRect stack_frame);
...
void SLSSpaceClientDrivenMoveSpacersToPoint(int edi_cid, long rsi_parentSpaceID, long rdx_tileSpaceID, long rcx_verticalIndex,
                                            long r8_horizontalIndex, int r9d_flags, double xmm0_location, double xmm1);
