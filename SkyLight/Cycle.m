...
void cycleSetup() {
    // cursed
    // VirtualBoxVM: (AppKit) The application with bundle ID org.virtualbox.app.VirtualBoxVM is running setugid(), which is not allowed.
    // Exiting.
...
#pragma clang diagnostic ignored "-Wobjc-method-access"
                ...
                [[NSApplication sharedApplication]
                    _cycleWindowsBypassingWindowManagerReversed:!!(event.modifierFlags & NSEventModifierFlagShift)];
#endif
