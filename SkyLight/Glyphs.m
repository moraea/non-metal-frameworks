...
void glyphsSetup() {
    swizzleImp(@"CUIShapeEffectStack", @"applyCustomForegroundColor:tintEffectColors:", true, (IMP)fake_applyCustomForegroundColor,
               (IMP*)&real_applyCustomForegroundColor);
}