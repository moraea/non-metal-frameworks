...
void blurFilterHack() { swizzleImp(@"CABackdropLayer", @"setFilters:", true, (IMP)fake_setFilters, (IMP*)&real_setFilters); }
#endif

void blurScaleHack() { swizzleImp(@"CABackdropLayer", @"setScale:", true, (IMP)fake_setScale, (IMP*)&real_setScale); }
